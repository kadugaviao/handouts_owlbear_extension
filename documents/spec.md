...
| B3 | Popover colava no canto da tela | Sem âncora explícita | Âncora no centro via `OBR.viewport.getWidth/getHeight`. **Esta correção causou o B22** — a leitura virou obrigatória num caminho que não podia falhar |
